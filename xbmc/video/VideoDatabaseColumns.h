...
constexpr int VIDEODB_DETAILS_MOVIE_FILESIZE            = VIDEODB_DETAILS_MOVIE_TABLE_LAST_ATTR + 24;
...
constexpr int VIDEODB_DETAILS_EPISODE_FILESIZE          = VIDEODB_DETAILS_EPISODE_TABLE_LAST_ATTR + 20;
...
constexpr int VIDEODB_DETAILS_MUSICVIDEO_FILESIZE       = VIDEODB_DETAILS_MUSICVIDEO_TABLE_LAST_ATTR + 11;
